...
\begin{document}{\sc \Large Curriculum Vitae -- Diego Amicabile}
\begin{resume}
...
% === PICTURE ===
    ...
    \begin{wrapfigure}{R}{0.15\textwidth}
         \vspace{-0.9cm}
        \begin{center}
        \includegraphics[width=0.15\textwidth]{diego_face.png}
        \end{center}
         \vspace{-1cm}
    \end{wrapfigure}
...
% === PERSONAL INFO ===
    ...
    Diego Amicabile \\
    \faTv  \space \href{http://www.amicabile.com}{www.amicabile.com} \\ 
    \faGithub  \space \href{https://github.com/diegoami/}{https://github.com/diegoami/} \\
    \faLinkedin \space \href{https://www.linkedin.com/in/diego-amicabile-378aa53/}{https://www.linkedin.com/in/diego-amicabile-378aa53/} \\ 
    \faEnvelope  \space \href{mailto:diego.amicabile@amicabile.com}{diego.amicabile@amicabile.com}
...
% === SKILLS ===
    ...
    \begin{description}
			\item[Programming languages:] \textbf{Java, Python, Pascal}, Javascript, C, C++
			\item[Databases:] \textbf{Java, Python, Pascal}, Javascript, C, C++
			\item[Databases:] 					
